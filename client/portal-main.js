                    ...
                    <div style="padding: 24px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 1px solid #f1f5f9;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                ...
                                <h4 style="font-family: 'Outfit', sans-serif; font-size: 18px; font-weight: 700; color: #0f172a; margin: 0;">${itemLabel} #${idx + 1}</h4>
                            </div>
            ...
            <div style="background:#ffffff;border:1px solid ${errorText ? '#fecaca' : '#e2e8f0'};border-left:4px solid ${errorText ? '#ef4444' : '#2563eb'};border-radius:12px;padding:24px;margin-bottom:24px;position:relative;box-shadow:0 4px 20px rgba(0,0,0,0.03);">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:16px;">
                    <div class="ob-field" style="gap:8px;">
                        ...
                        <select onchange="obUpdateCurrencyField(${idx}, 'currency', this.value)" ${isReadOnly ? 'disabled' : ''} style="width:100%;padding:12px 16px;border:1px solid #e2e8f0;border-radius:12px;background:#ffffff;color:#0f172a;font-size:14px;font-family:'Inter',sans-serif;appearance:none;background-image:url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%230f172a%22 stroke-width=%222.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><polyline points=%226 9 12 15 18 9%22></polyline></svg>');background-repeat:no-repeat;background-position:right 16px center;">
                    ...
                    <div class="ob-field" style="gap:8px;">
                        ...
                        <select onchange="obUpdateCurrencyField(${idx}, 'shareClass', this.value)" ${isReadOnly ? 'disabled' : ''} style="width:100%;padding:12px 16px;border:1px solid #e2e8f0;border-radius:12px;background:#ffffff;color:#0f172a;font-size:14px;font-family:'Inter',sans-serif;appearance:none;background-image:url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%230f172a%22 stroke-width=%222.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><polyline points=%226 9 12 15 18 9%22></polyline></svg>');background-repeat:no-repeat;background-position:right 16px center;">
                ...
                ${c.currency === 'Others' ? `
                    <div class="ob-field" style="margin-bottom:16px;gap:8px;">
                        ...
                        <input type="text" value="${c.customCurrency || ''}" placeholder="e.g. EUR, GBP" oninput="obUpdateCurrencyFieldLocal(${idx}, 'customCurrency', this.value)" onchange="obUpdateCurrencyField(${idx}, 'customCurrency', this.value)" ${isReadOnly ? 'disabled' : ''} style="width:100%;padding:12px 16px;border:1px solid #e2e8f0;border-radius:12px;background:#ffffff;color:#0f172a;font-size:14px;font-family:'Inter',sans-serif;box-sizing:border-box;">
                    </div>
                ` : ''}
